...
ruta_imagenes = r'F:\2 curso\pagina web\Proyecto_python\proyecto vpet\sprites_kazuha\\'
...
idle = [tk.PhotoImage(file=ruta_imagenes + 'idle.gif', format='gif -index %i' % i) for i in range(6)]
...
dormir_a_idle = [tk.PhotoImage(file=ruta_imagenes + 'sleep_to_idle.gif', format='gif -index %i' % i) for i in range(5)]
