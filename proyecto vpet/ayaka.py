...
ruta_imagenes = r'F:\2 curso\pagina web\Proyecto_python\proyecto vpet\sprtes_ayaka\\'
...
def evento(ciclo, estado, numero_evento, pos_x):
    if numero_evento in numeros_idle:
        ...
        estado = 2
        ventana.after(700, actualizar, ciclo, estado, numero_evento, pos_x)

    elif numero_evento == 14:
        estado = 3
        ventana.after(600, actualizar, ciclo, estado, numero_evento, pos_x)
