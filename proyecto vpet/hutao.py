...
ruta_imagenes = r'F:\2 curso\pagina web\Proyecto_python\proyecto vpet\sprites_hutao\\'
...
idle = [tk.PhotoImage(file=ruta_imagenes + 'idle.gif', format='gif -index %i' % i) for i in range(8)]
